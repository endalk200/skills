---
name: to-task
description: Break a plan, spec, or PRD into independently-grabbable tasks using tracer-bullet vertical slices. Use when user wants to convert a plan into tasks, create implementation tasks, or break down work into tasks.
---
...
Create task in dependency order (blockers first) so you can reference real task numbers in the "Blocked by" field.

<task-template>
## Parent

#<parent-task-number> (if the source was a task, otherwise omit this section)
