...
The collection currently contains 29 published skills under [`skills/`](skills/). See the [skills catalog](skills/README.md) for their purposes and invocation modes.
